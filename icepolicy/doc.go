...
// explicit signaling between trusted peers. Policy configures Pion to gather a
// synthetic host candidate and then publishes it as the selected link-local IP.
package icepolicy
